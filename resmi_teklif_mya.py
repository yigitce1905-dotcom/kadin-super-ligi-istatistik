...
OYUNCU   = "Mya Christie"
UYRUK    = "İskoçya / Scotland"
DOGUM    = "17.09.2004"
TARIH    = "27.07.2026"

# ── MALİ ŞARTLAR ──
AY       = 9
AYLIK    = 1100                   # USD net / ay
TOPLAM   = AY * AYLIK             # 9.900 USD
KOMISYON = round(TOPLAM * 0.10)   # %10 = 990 USD

# ── MENAJERLİK / ARACILIK ──
AJAN_SIRKET  = "DC Sports and Talent Womens"
...
para(f"Bu transferin gerçekleşmesi ve futbolcu sözleşmesinin imzalanması hâlinde Haymana Spor "
     ...
     f"menajerlik komisyonunu, oyuncunun temsilcisi {AJAN_SIRKET}'a ödeyecektir.")
...
para(f"Upon completion of the transfer and execution of the football player contract, Haymana "
     ...
     f"the player's total contractual salary, to {AJAN_SIRKET}, the player's representative.")
...
cikti = pathlib.Path.home() / "Desktop" / "Resmi_Teklif_Haymana_Mya_Christie.pdf"
