...
# ── OYUNCU KÜNYESİ (SD profilinden) ──
OYUNCU   = "Paola Blue Ellis"                      # SD tam ad: Paola Simone Nicole Ellis
UYRUK    = "Haiti / Haiti"
DOGUM    = "11.07.1999"
TARIH    = "22.07.2026"
...
# ── MALİ ŞARTLAR ──
AY       = 9
AYLIK    = 900                    # USD net / ay
TOPLAM   = AY * AYLIK             # 8.100 USD
KOMISYON = round(TOPLAM * 0.10)   # %10 = 810 USD
...
cikti = pathlib.Path.home() / "Desktop" / "Resmi_Teklif_Haymana_Ellis.pdf"
