...
OYUNCULAR = [
    ...
    ("SOL BEK", "Ecrin Naz Şentürk", MEVCUT, "17", "Türkiye", "1,56", "Bakırköy", "Bakırköy"),
    ("ÖN LİBERO", "Abigail Appiah", TRANSFER, "24", "Gana", "1,71", "Son kulüp: Hapoel Ra'anana (İsrail, 2025/26)",
     "Hapoel Ra'anana"),
