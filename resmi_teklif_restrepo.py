# -*- coding: utf-8 -*-
"""Haymana Spor Kulübü — Manuela Restrepo RESMÎ TRANSFER TEKLİFİ (iki dilli).

Menajerlik: KSirius Football Management (Paulo Veríssimo, FIFA LICENCE 202309-3718)
Aracı (Intermediary): Ideal Sports Management
"""
import sys, pathlib
...
# ── OYUNCU KÜNYESİ (SoccerDonna spieler_46571) ──
OYUNCU   = "Manuela Restrepo"
TAM_ISIM = "Manuela Restrepo Ramírez"
UYRUK    = "Kolombiya / Colombia"
DOGUM    = "25.02.2002"
TARIH    = "12.08.2026"

# ── MALİ ŞARTLAR ──
AY       = 9
AYLIK    = 750                    # USD net / ay
TOPLAM   = AY * AYLIK             # 6.750 USD
KOMISYON = round(TOPLAM * 0.10)   # %10 = 675 USD

# ── MENAJERLİK / ARACILIK ──
AJAN_SIRKET  = "KSirius Football Management"
AJAN_YETKILI = "Paulo Veríssimo"
AJAN_FIFA    = "FIFA LICENCE 202309-3718"
INTERMEDIARY = "Ideal Sports Management"

def usd(n):    return f"{n:,}".replace(",", ".")
def usd_en(n): return f"{n:,}"
...
etiket("Oyuncunun Adı Soyadı / Player's Full Name:", TAM_ISIM)
...
cikti = pathlib.Path.home() / "Desktop" / "Resmi_Teklif_Haymana_Restrepo.pdf"
