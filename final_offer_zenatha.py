# -*- coding: utf-8 -*-
"""Haymanaspor Kulübü — Zenatha Goeieman Coleman FINAL OFFER (Markovska/Amed şablonu, mavi-beyaz)."""
import sys, pathlib
...
pdf.cell(0, 6, "10.08.2026", align="R", ln=1)
pdf.ln(4)
...
pdf.multi_cell(0, 6.4, "Dear Madam,")
pdf.ln(1)
pdf.multi_cell(0, 6.4,
    "We will be happy to see Ms. Zenatha Goeieman Coleman in Haymanaspor Kulübü "
...
maddeler = [
    "Season duration: 9 months (September - May)",
    "1000 US DOLLAR net monthly salary",
    "Win bonus available for important wins",
    "Accommodation: hotel",
    "Round trip flight ticket (home country - Turkiye)",
    "2 meals (in club facilities)",
]
...
cikti = pathlib.Path.home() / "Desktop" / "Final_Offer_Haymana_Zenatha.pdf"
