...
Çıktı: Desktop\\ISM_Yuksekova_Shortlist_2026.pdf
"""
...
OYUNCULAR = [
 ...
 ("Fuseina Mumuni","SĞB","DEF","Gana","25 (2001)",164,"Çift","Mubadara (BAE)",
 ...
 ("Imana","STP (LCB)","DEF","Cezayir / Kanada","",176,"Sol","Son kulüp: BIIK Kazygurt (Kazakistan) — transfere açık",
 ...
 ("Renée Guion","SLB / DEF","DEF","ABD","26 (1999)",173,"","Carolina Ascent FC (USL Super League) — transfere açık",
 ...
 ("Essien Emem Peace","KNT / ST","FW","Nijerya","24 (2001)",170,"Çift","Kickstart FC (Hindistan)",
  ...
  ""),
 ("Courtney Jones","KNT / SĞB","FW","ABD","27 (1998)",0,"","Lexington SC (USL Super League)",
  "Clemson Üniv. çıkışlı; ABD genç milli kamp geçmişi (U14/U15/U18); doğal kanat — dış bek ve forvet de oynayabilir",
  "https://www.youtube.com/watch?v=rlJQJtapStM"),
...
pdf.cell(0, 6, "YÜKSEKOVA SPOR KULÜBÜ · KADIN FUTBOLU · YAZ 2026", ln=1)
...
def _grup_sayfa_ac(tr, en, adet):
    pdf.add_page(); zemin()
    marka_bandi(h=13, baslik="YÜKSEKOVA SHORTLIST · YAZ 2026")
...
cikti = pathlib.Path.home() / "Desktop" / "ISM_Yuksekova_Shortlist_2026.pdf"
